...
class Example(QWidget):
    ...
    def initUI(self):
       ...
       # ******browse label ko start******
        self.lbl = QLabel(self)                           #link aaune thau
        self.lbl.setGeometry(920, 30, 295, 35)            #browse labe ko geometry size
        self.lbl.setStyleSheet("background-color:lavenderblush;\n"              # label ko design 
                                    "\n"
                                    "color:#000;\n"
                                    ...
                                    "fx: 0.3, fy: -0.4,\n"
                                    "radius: 1.35, stop: 0 #fff, stop: 1 rgb(242, 241, 237));\n"
                                    "min-width: 80px;")
        self.lbl.move(10, 30)
        # ******browse label ko end******
        ...
        self.message_text.setGeometry(0, 30, 335, 30)  # browse labe ko geometry size
        ...
        # *********Broese button ko code start***********
        self.browse_btn = QPushButton('Browse Video', self)
        font = QtGui.QFont()
        font.setFamily("MV Boli")
        font.setPointSize(14)
        self.browse_btn.setGeometry(0, 30, 180, 40)
        font.setBold(True)
        ...
        self.browse_btn.move(80, 80)  # browse button ko position
        self.browse_btn.clicked.connect(self.showDialog)
        ...
        self.start_btn.move(80, 140)  # browse button ko position
        ...
        self.reset_btn.setStyleSheet("\n"
                                     ...
                                     "}")
        self.reset_btn.move(80, 200)
        # *******  reset button ko end*********

        # ******* back ko button ko start*********

        self.back_btn = QPushButton('Back', self)
        self.back_btn.clicked.connect(self.lbl.clear)
        font = QtGui.QFont()
        font.setFamily("MV Boli")
        font.setPointSize(15)
        font.setBold(True)
        ...
        #*******main background ko*********
        self.setGeometry(20, 30, 350, 740) #main dialog box ko height and width
        self.setWindowTitle('Recorded Video')
        self.show()
        # *******main background ko*********
...
class Thread(QThread):
    ...
    def run(self):
        ...
        while (cap.isOpened()):
            ...
            for c in contours:
                ...
                if M['m00'] == 0:
                    ...
                    if cv2.contourArea(c) < 1000 or cv2.contourArea(c) > 200000:
                        ...
                        msg = 'Date & Time : '+datetime.datetime.now().strftime("%A %d %B %Y %I:%M:%S%p")+'\n\nNo. of Object Detected : ' + str(count)+" \n\n"
                        ...
                        date = datetime.datetime.now().strftime("%A %d %B %Y %I:%M:%S%p")
                        ...
                        cv2.putText(img, '%s%.f' % ('Uniqueframeno:', len(countuniqueframe)), (550, 470),
            ...
            cv2.resizeWindow('video', 900, 650)
        ...
        msg2 = msg1 + "Contours recorded : "+ len(top_contours)+"\n\n"
        self.changeLabel.emit(str("\n" + msg2 + "\n"))
